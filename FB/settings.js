...
module.exports = (params) => {
  ...
  const fb_v = process.env.FB_GRAPH_VERSION;
  ...
  settings.group.url = `https://graph.facebook.com/${fb_v}/${settings.group.id}/feed?access_token=${settings.accessToken}&fields=${fields}`
